...
export function Scena({ momento, children, progetto, salvato, esci, occupato, uscita, accountEmail, progressione, benvenuto = false }: {
  ...
  return <main className={`onboard-scene moment-${momento} ${benvenuto ? 'is-welcome' : 'is-question'}`}>
