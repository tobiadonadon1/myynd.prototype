...
const EN: Record<string, string> = {
  ...
  'Apri il compito': 'Open task',
  'Caricamento…': 'Loading…',
  'Inserisci un indirizzo email completo, senza jolly o dominio generico.': 'Enter a complete email address, without wildcards or a domain-only pattern.',
  'Le regole della posta non sono leggibili; non le sovrascrivo.': 'Mail rules could not be read. The saved rules have not been overwritten.',
  'Questa regola può solo archiviare, mai cancellare.': 'This rule can only archive messages; it cannot delete them.',
  'Ci sono troppe regole: togline una prima di aggiungerne altre.': 'There are too many rules. Remove one before adding another.',
  'Regola non trovata.': 'Rule not found.',
  'Il registro delle regole è pieno; serve una revisione prima di continuare.': 'The rule history is full. Review it before continuing.',
  'La casella non ha confermato l’archiviazione di questo messaggio.': 'The mailbox did not confirm that this message was archived.',
  'Regole mittenti': 'Sender rules',
  'Le nuove email da questi indirizzi vengono archiviate mentre Myynd è in esecuzione. I messaggi restano nella casella: non vengono eliminati e il mittente non viene bloccato dal provider.': 'New emails from these addresses are archived while Myynd is running. Messages remain in your mailbox: they are not deleted, and the provider does not block the sender.',
  'Indirizzo esatto del mittente': 'Exact sender email address',
  'Archivia le prossime email': 'Archive future emails',
  'Nessuna regola mittente.': 'No sender rules yet.',
  'Rimuovi regola': 'Remove rule',
  'Le prossime email restano nella posta in arrivo.': 'Future messages will stay in your inbox.',
  'In attesa di nuove email': 'Waiting for new emails',
  'Ultimo controllo': 'Last checked',
  'Archiviate': 'Archived',
  'Impossibile caricare le regole mittenti.': 'Could not load sender rules.',
  'Impossibile salvare la regola mittente.': 'Could not save the sender rule.',
  'Impossibile rimuovere la regola mittente.': 'Could not remove the sender rule.',
  'Preparo il lavoro da rivedere.': 'Preparing work for your review.',
  'Nessun nuovo lavoro da preparare adesso.': 'No new work to prepare right now.',
  'Fino a due preparazioni al giorno: risposte nella tua posta, prossimi passi, fatture e campi di moduli da rivedere. Nessun invio, pagamento o finestra aperta.': 'Up to two preparations a day: replies in your email, next steps, invoices and form fields to review. No sending, payments or opened windows.',
  'Ora non valida nel fuso locale.': 'That time does not exist in your local time zone.',
  'Il progetto contiene un ciclo di cartelle.': 'The project contains a folder loop.',
  'Il progetto è troppo grande per una copia sicura.': 'The project is too large to copy safely.',
  'Il progetto contiene troppi file per una copia sicura.': 'The project contains too many files to copy safely.',
  'La cartella del progetto non esiste.': 'The project folder does not exist.',
  'Dalla tua chat': 'You said this in chat',
  'Dedotto da una fonte': 'Inferred from a source',
  'Non usato come informazione attuale: fonte o attività cambiata, mancante o datata.': 'Not used as current knowledge. The source or task changed, is missing, or is too old.',
  'Memoria non disponibile. Chiudi e riapri per riprovare.': 'Could not load this project’s memory. Close and reopen to retry.',
  'Prepara in anticipo': 'Prepare ahead',
  'Bozze pronte prima che le chieda': 'Drafts ready before you ask',
  'Mittenti che hai messo via': 'Senders you filed away',
  'La posta di questi mittenti va dritta in archivio.': 'Mail from these senders goes straight to the archive.',
  'Guardo cosa si ripete nel tuo lavoro…': 'Looking at what repeats in your work…',
  'Nuove automazioni proposte': 'New automations suggested',
  'Fino a due bozze di risposta al giorno, salvate nelle bozze della tua posta quando il collegamento lo consente. Niente viene inviato e nessuna finestra viene aperta.': 'Up to two reply drafts a day, saved in your email Drafts when the connection supports it. Nothing is sent and no windows are opened.',
  'In pausa: la tua autonomia è impostata su chiedere prima.': 'Paused: your autonomy setting is Ask first.',
  'Salvata nelle bozze della tua posta. Nessun messaggio inviato.': 'Saved in your email Drafts. Nothing sent.',
  'Apri la bozza nella posta': 'Open draft in Mail',
  'La bozza è qui, ma non è stata salvata nella posta.': 'The draft is here, but could not be saved in your email.',
  'Preparo una bozza nella tua posta.': 'Preparing a draft in your email.',
  'Nessuna nuova bozza da preparare adesso.': 'No new draft to prepare right now.',
  'Prepara ora': 'Prepare now',
  ...
  'Aggiungi una data': 'Add a date',
  'Aggiungi una fonte': 'Add a source',
  // — il primo avvio, stretto: una domanda concreta per schermata, e le due
  ...
  'Per che giorno': 'When',
  'Fonte': 'Source',
  'Myynd la legge e cita quello che serve al progetto.': 'Myynd reads it and quotes what matters for this project.',
  'Riprendi': 'Continue setup',
  'Configura il progetto': 'Set up your project',
  'Usa un altro account': 'Use another account',
  'Configuri il progetto per': 'Setting up a project for',
  ...
  'Linear e Jira': 'Linear and Jira',
  'Progetti, issue e decisioni dal posto in cui il team organizza il lavoro: arriva presto.': 'Projects, issues and decisions from where the team organizes work: coming soon.',
  ...
  'Collega quello che usi già. Myynd legge le fonti ed esegue le azioni che abiliti.': 'Connect what you already use. Myynd reads your sources and performs the actions you enable.',
  ...
  'che hai già.': 'you already have.',
  'Posta, file, note, agenda. Li colleghi una volta; li rilegge ogni giorno.': 'Mail, files, notes, calendar. Connect them once; it rereads them every day.',
  'La prima pagina': 'Your front page',
  'Una pagina': 'One page,',
  ...
  'Rispondere a Rossi sul preventivo': 'Reply to Rossi about the quote',
  'Re: Preventivo impianto': 'Re: Quote for the system',
  'Gentile Rossi, ecco il preventivo aggiornato: consegna in quattro settimane dalla conferma.': 'Dear Rossi, here is the updated quote: delivery four weeks from confirmation.',
  'Osserva': 'Watch',
  ...
  'Fonti, memoria e trasferimento': 'Sources, memory and transfer',
  'Account e app': 'Account and app',
  'Accesso, notifiche e sicurezza': 'Sign-in, notifications and security',
  'Scegli un’area. Le impostazioni meno usate restano fuori dalla strada finché non ti servono.': 'Choose an area. Less-used settings stay out of the way until you need them.',
  'Sezioni delle preferenze': 'Preference sections',
  ...
  'Salva la prima attività': 'Save first task',
  "Il tuo digital brain": "Your digital brain",
  "Meno rumore.": "Less noise.",
  "Più spazio per te.": "More room for you.",
  "I tuoi progetti, le tue idee. Una mente in più per portarli avanti.": "Your projects. Your ideas. A second mind to move them forward.",
  ...
  'Non riesco a rileggere questo avvio. I dati sono ancora al loro posto.': 'This setup could not be loaded. Your data is still saved.',
  'Questo avvio è cambiato in un’altra finestra. Rileggilo e riprova.': 'Setup changed in another window. Review it and try again.',
  'Scrivi un nome per il progetto, entro 160 caratteri.': 'Give your project a name, up to 160 characters.',
  'Scrivi un obiettivo concreto, entro 1.000 caratteri.': 'Write a concrete goal, up to 1,000 characters.',
  'Scegli prima il progetto e l’obiettivo.': 'Choose a project and goal first.',
  'Scegli una fonte disponibile oppure continua senza.': 'Choose an available source or continue without one.',
  'Scegli prima il progetto e una fonte, oppure salta la fonte.': 'Choose a project and a source, or skip the source.',
  'Scegli fino a tre estratti da confermare.': 'Choose up to three excerpts to confirm.',
  'Gli estratti sono cambiati. Rileggili prima di confermare.': 'The excerpts have changed. Review them before confirming.',
  'Conferma gli estratti o scegli esplicitamente di continuare senza.': 'Confirm the excerpts or choose to continue without them.',
  'Scrivi la prossima azione, entro 2.000 caratteri.': 'Write the next action, up to 2,000 characters.',
  "Il progetto": "The project",
  "La fonte": "The source",
  "La conferma": "The check",
  "Il primo risultato": "The first result",
  "Da dove": "Where shall",
  "cominciamo?": "we begin?",
  "Un punto": "A place",
  "di partenza.": "to begin.",
  "Mettiamo": "Let’s bring it",
  "a fuoco.": "into focus.",
  "Il tuo lavoro,": "Your work,",
  "un passo avanti.": "one step forward.",
  "Un progetto. Un obiettivo concreto.": "One project. One concrete goal.",
  ...
  "Salvato nella To-do": "Saved to your To-do",
  "Obiettivo": "Goal",
  "Estratti confermati": "Confirmed excerpts",
  "Attività ancora da svolgere": "Task still to do",
  "Una cosa da fare": "One thing to do",
  "Da quale azione concreta vuoi partire?": "What concrete action will you start with?",
  ...
  'Progetto collegato': 'Linked project',
  'Attività e risultati': 'Tasks and outcomes',
  'concluse': 'completed',
  'aperte': 'open',
  'Da rivedere': 'Ready for review',
  'Aspetta te': 'Needs you',
  'Completata': 'Completed',
  'Lasciata': 'Set aside',
  'Nessun risultato registrato.': 'No outcome recorded yet.',
  'Da quale passo partiamo?': 'What is the next step?',
  'Prossima azione…': 'Next action…',
  'Assegnazione': 'Assignment',
  'Al lavoro': 'Working',
  'In programma': 'Scheduled',
  'Già lette': 'Previously read',
  'Tutti': 'All',
  'Collegati': 'Connected',
  // Il titolo del gruppo, sopra le piastrelle: le fonti sono femminili.
  'Collegate': 'Connected',
  'Pianificazione': 'Schedule',
  'Senza data': 'No date',
  'Aggiungi per': 'Add for',
  'Cosa c’è da fare': 'What needs doing',
  'Priorità non valida.': 'That priority does not exist.',
  'Bassa': 'Low',
  'Normale': 'Normal',
  'Alta': 'High',
  'Cerca connessioni…': 'Search connections…',
  'Collegato': 'Connected',
  'Serve l’accesso': 'Needs access',
  'La lettura è sospesa: manca l’accesso al disco.': 'Reading is paused: disk access is required.',
  'Gestisci': 'Manage',
  'Lista': 'List',
  ...
  'Notizie selezionate': 'Selected news',
  ...
  "Risposte": "Replies",
  "Fatture": "Invoices",
  "Preventivi": "Proposals",
  "Usa @ per scegliere le fonti. Nasce in pausa.": "Use @ to choose sources. Starts paused.",
  ...
  'Scarta e chiudi': 'Discard and close',
  'Salva le modifiche per vedere quali documenti leggerà.': 'Save your changes to preview the documents this workflow will read.',

  "Aggiorna": "Refresh",
  "Attiva": "Active",
  "Attive": "Active",
  "Cerca automazioni…": "Search automations…",
  "Cerco opportunità nel tuo lavoro…": "Looking for opportunities in your work…",
  "Ci sono richieste che richiedono una risposta…": "There are requests that need a reply…",
  "Condizione": "Condition",
  "Continua solo se…": "Continue only if…",
  "Cosa legge": "Read from",
  "Crea automazione": "Create automation",
  "Cronologia esecuzioni": "Run history",
  "Da controllare": "Needs attention",
  "Dai documenti collegati, idee già pronte da rivedere. Le accendi tu.": "Ready-to-review ideas from your connected documents. You decide when they go live.",
  "Descrivi cosa ripeti ogni giorno. Myynd prepara il flusso, tu gli dai gli ultimi ritocchi.": "Describe something you repeat every day. Myynd builds the workflow; you make it yours.",
  "Documenti indicizzati": "Indexed documents",
  "Elabora con AI": "Process with AI",
  "Estrai le scadenze e raggruppa per progetto…": "Extract deadlines and group them by project…",
  "Filtra automazioni": "Filter automations",
  "Il prossimo passo lo prepara Myynd.": "Let Myynd find your next shortcut.",
  "Il risultato passa al prossimo passo.": "The result becomes the input for the next step.",
  "Il risultato per te": "Your result",
  "Il tuo primo aiuto quotidiano.": "Your first everyday helper.",
  "Istruzione": "Instruction",
  "Le automazioni girano mentre Myynd è aperto su questo computer.": "Automations run while Myynd is open on this computer.",
  "Le automazioni girano nel tuo spazio.": "Automations run in your workspace.",
  "Le idee migliori partono dal tuo lavoro.": "The best ideas start with your work.",
  "Le tue automazioni": "Your automations",
  "Meno lavoro ripetitivo": "Less busywork",
  "Modifica dettagli": "Edit details",
  "Mostra tutte": "Show all",
  "Nascondi dettagli": "Hide details",
  "Nessun risultato": "No matching automations",
  "Nessuna esecuzione. Provala per vedere il primo risultato.": "No runs yet. Try it to see your first result.",
  "Niente da fare": "Nothing to do",
  "Non collegato": "Not connected",
  "Non ora": "Dismiss",
  "Passo AI": "AI step",
  "Pensate per te": "Suggested for you",
  "Perché questa idea": "Why this idea",
  "Prepara": "Prepare",
  "Preparano risultati e bozze da rivedere.": "They prepare results and drafts for you to review.",
  "Prova un altro nome o cambia i filtri.": "Try another name or change your filters.",
  "Quando": "When",
  "Quando nei documenti collegati emergono fatture, preventivi o note di riunioni ricorrenti, trovi qui una proposta. Puoi sempre crearne una a parole.": "As recurring invoices, proposals or meeting notes appear in your connected documents, suggestions show up here. You can also describe your own.",
  "Quando parte": "Start when",
  "Rimandata": "Deferred",
  "Rimuovi passo": "Remove step",
  "Risultato": "Result",
  "Risultato preparato": "Result prepared",
  "Rivedi automazione": "Review workflow",
  "Salva e prova": "Save and try",
  "Se la condizione non è soddisfatta, il flusso si ferma senza creare una riga.": "If the condition is not met, the workflow stops without creating a task.",
  "Solo i nuovi documenti": "New documents only",
...
// — il giro —
  ...
  'Provale: decidono quanto se ne occupa lui.': 'Try them: they decide how much it takes on.',
...
// — l'avanzamento della lettura —
  ...
  'Arriva presto. Intanto la posta si collega da «Posta», con una password per le app.': 'Coming soon. For now, connect your mail from “Mail”, with an app password.',
  'Arriva presto: posta e agenda di Microsoft 365.': 'Coming soon: Microsoft 365 mail and calendar.',
  'Arriva presto, insieme a Gmail.': 'Coming soon, together with Gmail.',
  'Arriva presto, insieme a Outlook.': 'Coming soon, together with Outlook.',
  ...
  'es. guardo prima il margine, poi se il cliente paga puntuale': 'e.g. I look at the margin first, then whether the client pays on time',
  'Cosa controlli sempre, prima di dire di sì?': 'What do you always check before saying yes?',
  'es. che le date siano fattibili, e chi firma dall’altra parte': 'e.g. that the dates are doable, and who signs on the other side',
  'Come scrivi?': 'How do you write?',
  'es. corta, niente «gentilissimo», chiudo con «a presto»': 'e.g. short, no “Dear Sir”, I close with “speak soon”',
  'Quali errori non vuoi rivedere?': 'Which mistakes do you not want to see again?',
  'es. promettere consegne senza sentire la produzione': 'e.g. promising delivery dates without asking production',
  'Chi conta, e come stai con loro?': 'Who matters, and how do things stand with them?',
  'es. Rossi è il cliente più grosso, ma tratta sempre sul prezzo': 'e.g. Rossi is the biggest client, but always haggles on price',
  ...
  'Il conto Anthropic è senza credito': 'The Anthropic account has no credit',
  'Il conto del fornitore è senza credito': 'The provider account has no credit',
  'La chiave funziona. È il credito che manca: senza, ogni richiesta viene respinta e Myynd resta un archivio.': 'The key works. Credit is what is missing: without it every request is refused, and Myynd stays an archive.',
  'Entra su console.anthropic.com con lo stesso conto della chiave.': 'Sign in to console.anthropic.com with the same account as the key.',
  'Apri Billing e aggiungi credito: anche il minimo basta per cominciare.': 'Open Billing and add credit: the minimum is enough to start.',
  ...
  'Non sono riuscito a eliminare la chat.': 'I could not delete the chat.',
  'Non riesco a leggere il feed.': 'I cannot read the feed.',
  'Riprova': 'Try again',
  ...
  'Su un server non ci sono cartelle da leggere: le fonti sono quelle collegate in rete.': 'On a server there are no folders to read: your sources are the ones connected online.',
  'Su un server l’abbonamento non si può usare: qui ragiona con una chiave API.': 'On a server the subscription cannot be used: here it reasons with an API key.',
  'Su un server non posso lavorare in una cartella: serve Myynd sul tuo computer.': 'On a server I cannot work inside a folder: that needs Myynd on your computer.',
...
'tu': 'you',
  ...
  'Rispondigli e ci riprova': 'Answer and it tries again',
  'Manda': 'Send',
  'Non sono riuscito a rispondergli.': 'I could not answer it.',
  ...
  'La scrive lui, la mandi tu': 'It writes it, you send it',
  'Falla fare a lui': 'Let Myynd do it',
  ...
  "Torna com'era, senza il lavoro suo": 'Back as it was, without its work',
  'Aggiungila': 'Add it',
  'Per quando': 'For when',
  ...
  'Una fonte è stata completata, scartata o non è più pertinente mentre preparavo il risultato. Rileggi le fonti prima di riprovare.': 'While I was working, a source was completed, dismissed or became irrelevant. Refresh your sources before trying again.',
  'Una fonte è stata completata, scartata o non è più pertinente. Rileggi le fonti prima di riprovare.': 'A source was completed, dismissed or is no longer relevant. Refresh your sources before trying again.',
  ...
  'Affida a un agente locale…': 'Hand it to a local agent…',
  'Non c’è un agente locale compatibile su questo computer.': 'There is no compatible local agent on this computer.',
  'Agente locale': 'Local agent',
  'Claude Code è installato, ma manca l’accesso al suo account. Collegalo nelle Fonti per affidargli il progetto.': 'Claude Code is installed, but its account is signed out. Connect it in Sources before delegating the project.',
  'L’accesso a Claude Code non è ancora verificato. Riprova tra poco.': 'Claude Code sign-in has not been verified yet. Try again shortly.',
  'Agente esecutore + revisore Claude': 'Worker agent + Claude reviewer',
  'Il revisore richiede l’accesso a Claude Code. La chiave API collegata a Myynd non collega automaticamente il programma locale.': 'The reviewer requires Claude Code sign-in. An API key connected to Myynd does not automatically connect the local program.',
  'Criteri per accettare il risultato': 'Acceptance criteria',
  'L’esecutore lavora nella copia, poi il revisore controlla file e test. Un controllo incompleto ferma il risultato.': 'The worker edits the copy, then the reviewer checks files and tests. An incomplete review stops the result.',
  'Revisione accettata': 'Review accepted',
  'Revisione da completare': 'Review needs attention',
  'Esecutore': 'Worker',
  'Revisore': 'Reviewer',
  'Risultato da ottenere': 'Desired result',
  'File da affidare a Hermes': 'Files to share with Hermes',
  'src/esempio.ts, package.json': 'src/example.ts, package.json',
  'Questa modalità usa le credenziali di inferenza già presenti nel file .env di Hermes. Un accesso solo OAuth non è supportato. L’installazione non conferma che l’account sia collegato.': 'This mode uses inference credentials already present in the Hermes .env file. OAuth-only login is unsupported. Installation does not confirm a connected account.',
  'Mancano le credenziali di inferenza richieste per questa modalità di Hermes.': 'The inference credentials required for this Hermes mode are missing.',
  'non eseguita': 'not run',
  'non accettata': 'rejected',
  'incompleta': 'incomplete',
  'Modello Hermes': 'Hermes model',
  'Fornitore Hermes': 'Hermes provider',
  'Hermes propone modifiche solo ai file indicati. Myynd le applica nella copia e le verifica. Le impostazioni dell’agente restano come sono.': 'Hermes proposes changes only to the listed files. Myynd applies them in the copy and verifies them. The agent settings stay as they are.',
  'Affida a Hermes nella copia': 'Delegate to Hermes in the copy',
  ...
  'Adesso lavora in una copia del progetto. Il progetto collegato resta com’è.': 'It now works in a copy of the project. The connected project stays as it is.',
  'Modifiche verificate nella copia': 'Changes verified in the copy',
  'Modifiche da verificare nella copia': 'Changes awaiting verification in the copy',
  'Nessun file cambiato': 'No files changed',
  'Lavoro interrotto; copia salvata': 'Work interrupted; copy saved',
  'La verifica non è riuscita; copia salvata': 'Verification failed; copy saved',
  'File cambiati': 'Changed files',
  ...
  'Copia': 'Copy',
  'Apri la copia': 'Open the copy',
  'Il lavoro si è fermato prima di finire.': 'The work stopped before it finished.',
  ...
  'Non è ancora girata.': 'It hasn\'t run yet.',
  'l’ultima': 'last',
...
//   controlla che ce li siano tutti, così il prossimo non può sfuggire.
  ...
  // — il modello di casa: quello che può andare storto scaricandolo o accendendolo —
...
// — le automazioni —
  ...
  // I due titoli sopra i gruppi dell'elenco: le automazioni sono femminili.
  'Pronte': 'Ready',
  'Manca una connessione': 'A connection is missing',
  'A parole': 'In words',
  'I campi': 'The fields',
  ...
  'Non riesco a raggiungere il fornitore. Controlla l’indirizzo.': 'I can’t reach the provider. Check the address.',
  'Il fornitore è sotto sforzo. Riprova fra poco.': 'The provider is under load. Try again in a bit.',
  'Il fornitore ha rifiutato la richiesta. Controlla il modello nelle preferenze.': 'The provider rejected the request. Check the model in Preferences.',
  'Il fornitore ha un problema. Riprova fra poco.': 'The provider has a problem. Try again in a bit.',
  'Il fornitore non ha risposto. Riprova.': 'The provider didn’t answer. Try again.',
  'Il fornitore ha risposto con qualcosa che non so leggere.': 'The provider answered with something I can’t read.',
  'L’indirizzo del fornitore non è valido.': 'The provider address is not valid.',
  'Su un server il fornitore deve stare su https, fuori dalla rete interna.': 'On a server the provider must be on https, outside the internal network.',
  'Con http:// si resta in casa: 127.0.0.1, localhost o la rete locale.': 'With http:// you stay at home: 127.0.0.1, localhost or the local network.',
  'Servono l’indirizzo e il nome del modello.': 'The address and the model name are needed.',
  ...
  'Chiave API (se serve)': 'API key (if needed)',
  'Modello': 'Model',
...
// — mandare in un gesto: l'email è già pronta sotto la bozza —
  ...
  'Portami lì': 'Take me to it',
  'Vedi la fonte': 'View source',
  'Mappa dei documenti. Usa le frecce per selezionare un documento.': 'Document map. Use the arrow keys to select a document.',
  'Scegli un documento per leggerne il contenuto e i collegamenti.': 'Select a document to read its content and connections.',
  'Apri la fonte per leggere il documento.': 'Open the source to read this document.',
  'Cerca un documento…': 'Find a document…',
  'Sfoglia i documenti': 'Browse documents',
  'Progetti collegati': 'Related projects',
  'Argomenti in comune': 'Shared topics',
  'Escluso dai suggerimenti': 'Excluded from suggestions',
  'Aggiornamento per il punto': 'Brief update',
  'Possibile azione': 'Possible action',
  'Materiale di riferimento': 'Reference material',
  'Chiedi di questo documento…': 'Ask about this document…',
  ...
  'Disattivare qui mette in pausa ChatGPT solo in Myynd, senza uscire dal tuo account.': 'Turning this off pauses ChatGPT only in Myynd, without signing you out of your account.',
  'Accesso annullato. Il collegamento precedente resta invariato.': 'Sign-in cancelled. Your previous connection stays unchanged.',
  'Il tempo per l’accesso è terminato. Premi Accedi con ChatGPT per riprovare.': 'Sign-in timed out. Choose Sign in with ChatGPT to try again.',
  'L’accesso a ChatGPT non è riuscito. Riprova.': 'ChatGPT sign-in failed. Try again.',
  'Non sono riuscito ad annullare l’accesso.': 'I could not cancel sign-in.',
  'Usa i limiti del tuo piano ChatGPT tramite Codex su questo computer. Nessun passaggio automatico a una chiave API a pagamento.': 'Uses your ChatGPT plan limits through Codex on this computer. No automatic fallback to a paid API key.',
  'Account ChatGPT collegato': 'ChatGPT account connected',
  'Installa Codex, poi torna qui e aggiorna lo stato.': 'Install Codex, then return here and refresh the status.',
  'Accedi con ChatGPT nel browser. Una chiave API Codex non collega il tuo piano ChatGPT.': 'Sign in with ChatGPT in your browser. A Codex API key does not connect your ChatGPT plan.',
  'Completa l’accesso nel browser. Controllo lo stato per due minuti…': 'Finish signing in in your browser. Checking status for two minutes…',
  'Il controllo dell’accesso è terminato. Dopo aver completato l’accesso nel browser, premi Aggiorna stato.': 'The sign-in check has ended. After finishing in your browser, select Refresh status.',
  'Accesso completato. Scegli Usa ChatGPT per usarlo in Myynd.': 'Signed in. Choose Use ChatGPT to use it in Myynd.',
  'Non riesco a verificare l’accesso a ChatGPT.': 'I could not check the ChatGPT connection.',
  'Non sono riuscito ad aprire l’accesso a ChatGPT.': 'I could not open ChatGPT sign-in.',
  'Installa Codex': 'Install Codex',
  'Accedi con ChatGPT': 'Sign in with ChatGPT',
  'Usa ChatGPT': 'Use ChatGPT',
  'Disattiva per Myynd': 'Turn off for Myynd',
  'Disattivato in Myynd': 'Off in Myynd',
  'Da verificare': 'Check needed',
  'Disattivato in Myynd. Seleziona per riattivare.': 'Off in Myynd. Select to turn it back on.',
  'Aggiorna stato': 'Refresh status',
  'Interrompi il controllo': 'Stop checking',
  'Disattivare qui non esce dal tuo account ChatGPT o Codex.': 'Turning this off keeps you signed in to ChatGPT and Codex.',
  'Collega il tuo account ChatGPT dalle Fonti.': 'Connect your ChatGPT account in Sources.',
  'Gestisci nelle Fonti': 'Manage in Sources',
  'Claude Code su questo computer': 'Claude Code on this computer',
  'L’accesso con un abbonamento Claude.ai non è attualmente supportato per Myynd. Usa una chiave API Anthropic.': 'Claude.ai subscription sign-in is not currently supported for Myynd. Use an Anthropic API key.',
  'Connessione locale precedente. L’accesso con un abbonamento Claude.ai non è attualmente supportato per nuove connessioni Myynd; usa una chiave API Anthropic.': 'Existing local connection. Claude.ai subscription sign-in is not currently supported for new Myynd connections; use an Anthropic API key.',
  'Indicazioni ufficiali Anthropic': 'Official Anthropic guidance',
  'Usa la sessione locale di Claude Code già configurata. Disponibilità e limiti dipendono dal tuo account.': 'Uses the local Claude Code session already configured. Availability and limits depend on your account.',
  'Posizione originale': 'Original location',
  'Materiale salvato dalle fonti, inclusi gli archivi. Le linee mostrano parole in comune. Le attività vengono selezionate in base alla rilevanza.': 'Saved source material, including archives. Lines show shared words. Tasks are selected by relevance.',
  'Già completato': 'Already completed',
  'Progetto chiuso': 'Closed project',
  'Leggo il documento…': 'Reading the document…',
  'Conservato come contesto storico; non richiede attenzione adesso.': 'Kept as historical context; it does not need attention now.',
  'Questo messaggio è già stato inviato.': 'This message has already been sent.',
  'Conservato per consultazione, non come nuova richiesta.': 'Kept for reference rather than treated as a new request.',
  'Il mittente non è stato identificato con certezza.': 'The sender could not be reliably identified.',
  'Messaggio automatico o inviato a una lista; escluso dalle attività.': 'An automated or mailing-list message; excluded from tasks.',
  'Già letto, senza una nuova richiesta da seguire.': 'Already read, with no new request to follow up.',
  'Messaggio diretto e recente; da valutare insieme ai tuoi impegni.': 'A recent direct message to consider alongside your commitments.',
  'Aggiornamento su un ordine, una consegna o un servizio.': 'An update about an order, delivery, or service.',
  'Un evento del tuo calendario.': 'An event from your calendar.',
  'Attività recente del repository, utile per il punto.': 'Recent repository activity for your briefing.',
  'Aggiornamento di un progetto che stai seguendo.': 'An update to a project you are following.',
  'Contiene una richiesta relativa a un progetto attivo.': 'Contains a request related to an active project.',
  'Non è collegato a un progetto attivo.': 'It is not linked to an active project.',
  'Hai già completato questa attività. La fonte resta consultabile.': 'You have already completed this task. Its source remains available.',
  'Hai escluso questo suggerimento. La fonte resta consultabile.': 'You dismissed this suggestion. Its source remains available.',
  'Copia la bozza': 'Copy draft',
  'Copia la bozza e apri l’email': 'Copy draft and open email',
  'Invia questa bozza dal tuo programma di posta dopo averla riletta.': 'Review this draft and send it from your mail app.',
  'Bozza copiata. Non ho potuto aprire l’email: aprila dal tuo programma di posta.': 'Draft copied. I could not open the email; open it in your mail app.',
  'Bozza copiata. Incollala nella risposta, rileggila e inviala dal tuo programma di posta.': 'Draft copied. Paste it into your reply, review it, and send it from your mail app.',
  'Aggiornamenti': 'Updates',
  'Nessun collegamento alla fonte disponibile.': 'No source link is available.',
  'Non posso aprire l’originale. Questa è la copia salvata della fonte.': 'The original could not be opened. This is the saved copy of the source.',
  'Il collegamento alla fonte non è valido.': 'The source link is invalid.',
  'Consenti le finestre a comparsa per aprire la fonte.': 'Allow pop-ups to open the source.',
  'Il lavoro si è interrotto prima di essere completo. Riprova.': 'The work stopped before it was complete. Try again.',
  'Il lavoro non ha prodotto un risultato completo. Riprova.': 'The work did not produce a complete result. Try again.',
  // le mani di chi lavora (server/mani.ts): quello che una mano risponde
  // quando non può, e che può finire sotto una riga
  'Il lavoro è stato fermato.': 'The work was stopped.',
  'Permetti a Myynd di controllare Note in Impostazioni di Sistema, Privacy e sicurezza, Automazione, poi riprova.': 'Allow Myynd to control Notes in System Settings, Privacy & Security, Automation, then retry.',
  ...
  'Questo file è riservato: chiavi, credenziali o dati di sistema non si leggono.': 'This file is private: keys, credentials and system data are not read.',
  'Questo percorso è una cartella, non un file.': 'This path is a folder, not a file.',
  'Su un server non ho un disco da leggere.': 'On a server there is no disk for me to read.',
  'Questo file è troppo grande per essere letto qui.': 'This file is too large to read here.',
  'Questo file non è testo: non lo so leggere.': 'This file is not text: I cannot read it.',
  'Questo non è un indirizzo web valido.': 'This is not a valid web address.',
  'Un indirizzo con dentro delle credenziali non si legge.': 'An address with credentials in it is not read.',
  'Questo indirizzo è di casa o della rete locale: non lo leggo.': 'This address is local or on the private network: I do not read it.',
  'Questo indirizzo non risponde: il nome non si risolve.': 'This address does not answer: the name does not resolve.',
  'La pagina non ha risposto entro quindici secondi.': 'The page did not answer within fifteen seconds.',
  'La pagina rimanda altrove troppe volte.': 'The page redirects too many times.',
  'Questa pagina non è testo: non la so leggere.': 'This page is not text: I cannot read it.',
  'La pagina non ha testo leggibile.': 'The page has no readable text.',
  'Manca cosa cercare.': 'There is nothing to search for.',
  'La ricerca sul web non ha risposto entro quindici secondi.': 'The web search did not answer within fifteen seconds.',
  'Le note in Note si creano solo da Myynd sul Mac.': 'Notes are created only from Myynd on the Mac.',
  'Serve un titolo per la nota, in una riga sotto i duecento caratteri.': 'The note needs a title, on one line under two hundred characters.',
  'Serve il testo della nota, sotto i ventimila caratteri.': 'The note needs its text, under twenty thousand characters.',
  'Il nome della cartella di Note è troppo lungo.': 'The Notes folder name is too long.',
  'Note non ha confermato la nota.': 'Notes did not confirm the note.',
  ...
  'Su un server non posso lavorare in una cartella.': 'On a server I cannot work in a folder.',
  'Questa riga non ha una cartella di progetto.': 'This line has no project folder.',
  ...
  'La chiave API è già salvata. Non serve incollarla di nuovo.': 'Your API key is already saved. You do not need to paste it again.',
  'Lascia vuoto per mantenere la chiave salvata': 'Leave blank to keep your saved key',
  ...
  'Il Mac nega l’accesso a questa copia di Myynd. Se il permesso è già attivo, chiudi Myynd completamente e riapri la copia in Applicazioni.': 'macOS denied access to this copy of Myynd. If access is already enabled, quit Myynd completely and reopen the copy in Applications.',
  ...
  'Claude, con il tuo account o con una chiave API. Puoi collegare tutt’e due e scegliere quale lavora.':
    'Claude, with your account or with an API key. You can connect both and choose which one works.',
  'ChatGPT, con il tuo account o con una chiave API OpenAI. Puoi collegare tutt’e due e scegliere quale lavora.':
    'ChatGPT, with your account or with an OpenAI API key. You can connect both and choose which one works.',
  'Con il tuo account Claude': 'With your Claude account',
  'Con il tuo account ChatGPT': 'With your ChatGPT account',
  'Con una chiave API': 'With an API key',
  'Con la chiave API': 'With the API key',
  'Con il tuo account, tramite Claude Code': 'With your account, through Claude Code',
  'ChatGPT, con il tuo account': 'ChatGPT, with your account',
  'Serve Claude Code': 'Needs Claude Code',
  'Non disponibile': 'Unavailable',
  'Passa da Claude Code su questo computer: è lui a fare l’accesso e a tenere le credenziali. Non costa niente oltre al tuo piano.':
    'It goes through Claude Code on this computer: Claude Code signs in and keeps the credentials. Nothing to pay beyond your plan.',
  'Come si installa': 'How to install it',
  'Completa l’accesso nel browser e torna qui. Se il browser non si è aperto: Terminale, scrivi «claude», fai l’accesso.':
    'Finish signing in in your browser and come back here. If the browser did not open: Terminal, type “claude”, sign in.',
  'Completa l’accesso nel browser e torna qui.': 'Finish signing in in your browser and come back here.',
  'Accedi con Claude': 'Sign in with Claude',
  'Accedi con un altro account': 'Sign in with another account',
  'Usa il mio account': 'Use my account',
  'Usa la chiave': 'Use the key',
  'Collega con la chiave': 'Connect with the key',
  'Cambia chiave o modello': 'Change key or model',
  'L’accesso a Claude non è riuscito. Riprova.': 'Claude sign-in failed. Try again.',
  'Il tempo per l’accesso è terminato. Riprova.': 'Sign-in timed out. Try again.',
  'Entri dal browser e usi i limiti del tuo piano. Non serve una chiave, e non si passa mai a una chiave a pagamento da soli.':
    'You sign in from the browser and use the limits of your plan. No key needed, and it never switches to a paid key on its own.',
  'A consumo, sul credito OpenAI. Il modello lo scegli tu.': 'Pay as you go, on your OpenAI credit. You pick the model.',
  'Su platform.openai.com apri «API keys» e creane una.': 'On platform.openai.com open “API keys” and create one.',
  'Incolla qui la chiave: comincia per sk-.': 'Paste the key here: it starts with sk-.',
  'Serve il nome del modello.': 'The model name is required.',
  'Prima collega OpenAI con una chiave API.': 'Connect OpenAI with an API key first.',
  'Questo accesso non c’è più.': 'This sign-in is gone.',
  'Non so quale modello usare per uno dei livelli di lavoro.': 'I do not know which model to use for one of the work levels.',
  'Un modello sul tuo computer, o un altro fornitore': 'A model on your computer, or another provider',

  // — quale modello, per quale lavoro —
  'Quale modello, per quale lavoro': 'Which model, for which work',
  'Haiku costa un decimo di Sonnet, Opus cinque volte tanto. Scegli dove spendere.': 'Haiku costs a tenth of Sonnet, Opus five times as much. Choose where to spend.',
  'Lavoro di servizio': 'Housekeeping',
  'Titoli, smistamento della posta, traduzioni, rassegna, ritratto.': 'Titles, mail sorting, translations, the news digest, your portrait.',
  'Letture di ogni giorno': 'Everyday reading',
  ...
  // — i binari: l'automazione composta a pezzi —
  'Nuova automazione': 'New automation',
  'Dilla in una frase, o componila sui binari. Nasce in pausa.': 'Say it in a sentence, or build it on the rail. It starts paused.',
  'Dilla in una frase': 'Say it in a sentence',
  'Ogni lunedì mattina dimmi quali preventivi nella posta sono ancora senza risposta': 'Every Monday morning tell me which quotes in my mail are still unanswered',
  'Componi con Myynd': 'Compose with Myynd',
  'La compongo…': 'Composing…',
  'Composta. Guarda i binari: se dicono quello che volevi, creala.': 'Composed. Check the rail: if it says what you meant, create it.',
  'Preventivi fermi': 'Quotes gone quiet',
  'La creo…': 'Creating…',
  'Nasce in pausa: la accendi dalla sua scheda.': 'It starts paused: switch it on from its card.',
  'Le manca cosa deve fare: scrivilo nel tratto «Fa», o componila con Myynd.': 'It still needs what to do: write it in the “Does” stretch, or compose it with Myynd.',
  'Binari': 'Builder',
  'Legge': 'Reads',
  'Solo se': 'Only if',
  'Poi': 'Then',
  'Fa': 'Does',
  'Mette': 'Puts',
  'Quando arriva qualcosa': 'When something arrives',
  'Ogni giorno': 'Every day',
  'Ogni settimana': 'Every week',
  'Che giorno': 'Which day',
  'Le fonti': 'Sources',
  'Scrivi @ per dire da dove legge': 'Type @ to say what it reads',
  '@ per un’altra': '@ for another',
  'Senza nessuna fonte, guarda solo quello che ha già letto.': 'With no source, it only looks at what it has already read.',
  'Senza parole di ricerca guarda tutto quello che arriva da lì.': 'With no search words it looks at everything that arrives from there.',
  'Con queste parole': 'With these words',
  'preventivo, offerta, in attesa…': 'quote, offer, pending…',
  'Le parole di chi ha scritto quei documenti, nella loro lingua. Vuoto: solo quello che è arrivato dall’ultima volta.': 'The words of whoever wrote those documents, in their language. Empty: only what arrived since last time.',
  'Trascina per riordinare': 'Drag to reorder',
  'continua solo se c’è una richiesta che aspetta una risposta…': 'continue only if there is a request waiting for an answer…',
  'estrai le scadenze e raggruppale per progetto…': 'pull out the deadlines and group them by project…',
  'Solo se…': 'Only if…',
  'Poi rielabora…': 'Then rework…',
  'Dimmi quali preventivi sono ancora senza risposta: chi, cosa, da quanto. Se non ce n’è, dillo e basta.': 'Tell me which quotes are still unanswered: who, what, for how long. If there are none, just say so.',
  'Quanto fa': 'How much it does',
  'Mette una riga': 'Puts a line',
  'Prepara anche il lavoro': 'Prepares the work too',
  'Fa tutto il lavoro': 'Does the whole job',
  'Prepara il prompt': 'Prepares the prompt',
  'In che lista': 'Which list',
  'Una riga per ogni documento, non una riga con l’elenco': 'One line per document, not one line with the list',
  'legge': 'reads',
  'guarda quello che ha già letto': 'looks at what it has already read',
  'cercando': 'looking for',
  'un passaggio in mezzo': 'one step in between',
  'passaggi in mezzo': 'steps in between',
  'prepara anche il lavoro': 'prepares the work too',
  'fa tutto il lavoro': 'does the whole job',
  'mette una riga in lista': 'puts a line on your list',
  'una per documento': 'one per document',
  'Quello che ha già letto': 'What it has already read',
  'e': 'and',
  ...
  // — P6: inizio —
  // la prova sugli ultimi 30 giorni, il vassoio, la riga sulla scheda
  'Prova': 'Practice',
  'La provo…': 'Trying it…',
  'La faccio girare…': 'Running it…',
  'Termina la prova': 'Go live now',
  'cambiata da allora': 'changed since',
  'La provo sugli ultimi 30 giorni…': 'Trying it on the last 30 days…',
  'Negli ultimi 30 giorni non ha trovato niente da leggere.': 'It found nothing to read in the last 30 days.',
  'Fermata al tetto di spesa di oggi.': 'Stopped at today\'s spending cap.',
  'Fermata: il tuo account Claude è occupato.': 'Stopped: your Claude account is busy.',
  'Sei prove oggi. La prossima domani.': 'Six practices today. The next one tomorrow.',
  'Interrotta: Myynd si è chiuso.': 'Interrupted: Myynd closed.',
  'La prova non è riuscita.': 'The practice didn\'t finish.',
  'Collega un modello per provarla.': 'Connect a model to try it.',
  'Cambiata dopo questa prova.': 'Changed since this practice.',
  'Provala di nuovo': 'Try it again',
  'Senza agenda: nel passato non si legge.': 'Without the calendar: it can\'t be read in the past.',
  'Senza Claude Code: nel passato non gira.': 'Without Claude Code: it doesn\'t run in the past.',
  'Ancora pochi risultati per giudicare': 'Not enough results to judge yet',
  'Tutta la bozza': 'Full draft',
  'Scrivi la bozza': 'Write the draft',
  'La tua risposta': 'Your reply',
  'Fonte non più disponibile': 'Source no longer available',
  'Giusta': 'Right',
  'Sbagliata': 'Wrong',
  'Vassoio di prova': 'Practice tray',
  'Metti in lista': 'Move to list',
  'Non serve': 'Not needed',
  'Non manda e non cancella. Le bozze ti aspettano.': 'Never sends or deletes. Drafts wait for you.',
  'Nuovi risultati in prova': 'New practice results',
  // gli errori del server
  'È in pausa: provala sugli ultimi 30 giorni.': 'It is paused: try it on the last 30 days.',
  'È ancora in prova: provala sugli ultimi 30 giorni.': 'It is still in practice: try it on the last 30 days.',
  'Questa prova ha già dieci bozze.': 'This practice already has ten drafts.',
  'Non conosco questa prova.': 'I don\'t know this practice.',
  'Non conosco questo risultato.': 'I don\'t know this result.',
  'Questo risultato non è più nel vassoio.': 'This result is no longer in the tray.',
  'La prova ha finito il suo budget.': 'The practice ran out of its budget.',
  'Il calendario nel passato non si legge.': 'The calendar can\'t be read in the past.',
  'Claude Code nel passato non gira.': 'Claude Code doesn\'t run in the past.',
  'Hai già risposto.': 'You already replied.',
  'Nella prova questa porta resta chiusa.': 'In a practice this door stays closed.',
  'Ora della prova non valida.': 'The practice time is not valid.',
  // — P6: fine —
  ...
  // — P8: inizio —
  // la salute delle fonti: la riga fissa con il suo rimedio, le schede, il pannello con i trenta giorni
  'la posta': 'your mail',
  'le Note': 'Notes',
  'il tuo Mac': 'your Mac',
  'il tuo PC': 'your PC',
  'le conversazioni': 'your chats',
  '{a} e {b}': '{a} and {b}',
  'Non riesco a leggere {nome}: manca l’accesso completo al disco.': 'I can’t read {nome}: Full Disk Access is off.',
  'Dall’aggiornamento non riesco a leggere {nome}: togli e rimetti Myynd in Accesso completo al disco.': 'Since the update I can’t read {nome}: remove Myynd from Full Disk Access and add it again.',
  'Non riesco ancora a leggere {nome}. Se il permesso è già acceso, riapri Myynd.': 'I still can’t read {nome}. If the permission is already on, reopen Myynd.',
  'Leggo {nome} solo in parte: manca l’accesso completo al disco.': 'I only read part of {nome}: Full Disk Access is off.',
  'Devo accedere di nuovo a {nome}.': 'I need to sign in to {nome} again.',
  'Anthropic si è scollegato.': 'Anthropic signed out.',
  '{nome} non accetta più la password.': '{nome} no longer accepts the password.',
  ...
  'Non riesco a raggiungere {nome} {da}.': 'I can’t reach {nome} {da}.',
  'Non riesco a leggere {nome}.': 'I can’t read {nome}.',
  'Leggo {nome} solo in parte.': 'I only read part of {nome}.',
  'Non ho letto tutto: {elenco}.': 'I couldn’t read everything: {elenco}.',
  ...
  'manca l’accesso completo al disco': 'Full Disk Access is off',
  'serve un nuovo accesso': 'it needs a new sign-in',
  'la password non va più': 'the password no longer works',
  'l’indirizzo non va più': 'the address no longer works',
  'il token non va più': 'the token no longer works',
  'la chiave non va più': 'the key no longer works',
  'aspetta il via libera del tuo amministratore': 'waiting for your admin’s approval',
  'non si trova su questo Mac': 'not found on this Mac',
  'a Myynd serve un aggiornamento': 'Myynd needs an update',
  'non risponde più': 'not responding',
  'non si legge': 'it can’t be read',
  'si legge solo in parte': 'only part of it can be read',
  'Aspetto il permesso…': 'Waiting for the permission…',
  'Riapri Myynd': 'Reopen Myynd',
  'Riapro…': 'Reopening…',
  'Apro l’accesso…': 'Opening sign-in…',
  'L’accesso non è riuscito.': 'Sign-in didn’t work.',
  'Posso di nuovo leggere {nome}.': 'I can read {nome} again.',
  'Anthropic è di nuovo collegato.': 'Anthropic is connected again.',
  'Vedo di nuovo i titoli delle finestre.': 'I can see window titles again.',
  'Da sistemare': 'Needs fixing',
  'Ultima mail {n} giorni fa': 'Last email {n} days ago',
  'Ultimo messaggio {n} giorni fa': 'Last message {n} days ago',
  'Ultima riunione {n} giorni fa': 'Last meeting {n} days ago',
  'Ultimo file {n} giorni fa': 'Last file {n} days ago',
  'Ultimo arrivo {n} giorni fa': 'Last arrival {n} days ago',
  'Nessun evento nell’ultima lettura': 'No events in the last read',
  'Solo un evento nell’ultima lettura': 'Only one event in the last read',
  'Solo {n} eventi nell’ultima lettura': 'Only {n} events in the last read',
  'Nessuna nota nell’ultima lettura': 'No notes in the last read',
  'Solo una nota nell’ultima lettura': 'Only one note in the last read',
  'Solo {n} note nell’ultima lettura': 'Only {n} notes in the last read',
  'Nessuna riunione nell’ultima lettura': 'No meetings in the last read',
  'Solo una riunione nell’ultima lettura': 'Only one meeting in the last read',
  'Solo {n} riunioni nell’ultima lettura': 'Only {n} meetings in the last read',
  '{n} giorni su {m} senza guai': '{n} of {m} days without trouble',
  'Un giorno su {m} senza guai': 'One of {m} days without trouble',
  'Nessun giorno su {m} senza guai': 'None of {m} days without trouble',
  '{giorno}: senza guai': '{giorno}: no trouble',
  '{giorno}: un guaio': '{giorno}: a problem',
  '{giorno}: non letta': '{giorno}: not read',
  'Il token di Notion non va più.': 'The Notion token no longer works.',
  'Non sono riuscito ad aprire le Impostazioni.': 'I couldn’t open Settings.',
  'Non sono riuscito a riaprire Myynd.': 'I couldn’t reopen Myynd.',
  // — P8: fine —
