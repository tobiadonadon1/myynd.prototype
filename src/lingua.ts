...
// — le automazioni —
  ...
  'Un fornitore compatibile con OpenAI': 'An OpenAI-compatible provider',
  'Il predefinito. Myynd è stato messo a punto su Claude: le risposte, le bozze e il feed passano di lì, con la chiave o con il tuo abbonamento.': 'The default. Myynd was tuned on Claude: answers, drafts and the feed go through it, with your key or your subscription.',
  'OpenAI, OpenRouter, Groq, Mistral — o un modello in casa con Ollama o LM Studio. Lo colleghi con un indirizzo e il nome di un modello.': 'OpenAI, OpenRouter, Groq, Mistral — or a model at home with Ollama or LM Studio. You connect it with an address and a model name.',
  'Cambia': 'Change',
  'Non ancora collegato: scegliendolo si apre la scheda per collegarlo.': 'Not connected yet: choosing it opens the card to connect it.',
