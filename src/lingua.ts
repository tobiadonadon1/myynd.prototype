...
const EN: Record<string, string> = {
  ...
  'Quando sul feed arriva una cosa che vuole una risposta o un passo, Myynd la prepara in sottofondo: al massimo due al giorno, e non manda mai niente.': 'When something lands on your feed that needs a reply or a next step, Myynd prepares it in the background: two a day at most, and it never sends anything.',
  ...
  'Funziona mentre Myynd è aperto e il Mac è sveglio.': 'Works while Myynd is open and your Mac is awake.',
...
// — mandare in un gesto: l'email è già pronta sotto la bozza —
  ...
  'Le fonti': 'Sources',
  'Trascina qui una fonte, o toccala sotto. Senza, guarda solo quello che ha già letto.': 'Drag a source here, or tap one below. Without any, it only looks at what it has already read.',
  ...
  'Scrive anche la bozza': 'Writes the draft too',
