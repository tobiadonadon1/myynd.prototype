...
import { chiedi, chiediJSON, collegato as claudeCollegato, conLaLingua, estraiJSON, inItaliano, motore, parametri, SILENZIO_MAX } from './modello.ts'
...
export async function svolgi(
  ...
  for (let giro = 0; giro < tettoGiri; giro++) {
    ...
    // risposta lenta. Gli errori arrivano già in italiano: li traduce lui.
